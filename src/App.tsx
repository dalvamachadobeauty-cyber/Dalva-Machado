...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex justify-center">
      {/* Container to mimic Link-in-Bio width on Desktop, full width on Mobile */}
      <div className="w-full max-w-[480px] bg-white shadow-xl min-h-screen relative pb-20 overflow-hidden">
        ...
        {/* --- 2) HERO SECTION --- */}
        <section className="relative h-[440px] w-full flex flex-col items-center justify-end text-center px-8 pb-16 animate-fade-in-up">
        ...
        <RevealSection className="px-6 py-8 bg-white border-b border-gray-50 relative z-20 -mt-8 rounded-t-[2rem] shadow-[0_-10px_40px_rgba(0,0,0,0.05)]">
        ...
        <RevealSection className="px-6 py-8 bg-white">
        ...
        <RevealSection className="px-6 py-14 bg-white border-t border-gray-50" id="course">
           ...
           <div className="rounded-xl overflow-hidden shadow-2xl border border-gray-100 bg-black aspect-[9/16] max-w-[280px] mx-auto relative group">
             <iframe 
               width="100%" 
               height="100%" 
        ...
        {/* --- 3) SERVICES --- */}
        <RevealSection className="px-6 py-12 bg-white pt-4" id="services">
